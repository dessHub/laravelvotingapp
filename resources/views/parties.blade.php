        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/parties') }}">
                        {{ csrf_field() }}
                       <div class="col-md-4">
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                         ...
                         <div class="col-md-4">
                          <div class="form-group{{ $errors->has('slogan') ? ' has-error' : '' }}">
                              <label for="slogan" class="col-md-12 control-label">Slogan</label>
                        ...
                        <tbody>
                          @foreach($parties as $key)
                            <tr>
                              ...
                              <td>{{ $key->name }}</td>
                              <td>{{ $key->slogan }}</td>
                              <td><button class="btn btn-danger"><a href="{{ url('/delParty'.$key->id)}}">
                                  <i class="fa fa-btn fa-remove"></i> Constituency</a>
                              </button></td>
